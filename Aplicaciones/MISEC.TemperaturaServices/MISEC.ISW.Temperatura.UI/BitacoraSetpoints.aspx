<%@ Page Title="" Language="C#" MasterPageFile="~/Sensado.master" AutoEventWireup="true" CodeFile="BitacoraSetpoints.aspx.cs" Inherits="BitacoraSetpoints" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" Runat="Server">
    <table class="auto-style1">
        <tr>
            <td colspan="2">
                <div class="title">
				<h1>BITACORA DE SETPOINTS</h1>
				    <span class="byline">BITACORA DE CONTROL DE SETPOINTS, USUARIO Y RANGO DE FECHAS</span></div>
            </td>
        </tr>
        <tr>
            <td>
